...
export TERRAFORM_PROVIDER_SOURCE ?= DrFaust92/bitbucket
export TERRAFORM_PROVIDER_REPO ?= https://github.com/DrFaust92/terraform-provider-bitbucket
export TERRAFORM_PROVIDER_VERSION ?= 2.42.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-bitbucket
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-bitbucket_v2.42.0
...
xpkg.build.provider-bitbucket: do.build.images
