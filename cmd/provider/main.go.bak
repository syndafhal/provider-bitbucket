...
import (
	...
	"github.com/upbound/provider-bitbucket/apis"
	"github.com/upbound/provider-bitbucket/apis/v1alpha1"
	"github.com/upbound/provider-bitbucket/config"
	"github.com/upbound/provider-bitbucket/internal/clients"
	"github.com/upbound/provider-bitbucket/internal/controller"
	"github.com/upbound/provider-bitbucket/internal/features"
)
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Bitbucket controllers")
